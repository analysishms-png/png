...
function toggleTravelAgent(bookingSource) {
    ...
    var travelAgent = document.getElementById("travel_agent");
    console.log(bookingSource);

    if (bookingSource === "Travel Agency (OTA)" || bookingSource === "Travel Agency") {
    ...
    Array.from(travelAgent.options).forEach(function (option) {
        if (option.value === "") {
            option.style.display = "";
            return;
        }

        option.style.display = option.dataset.comp_type === bookingSource ? "" : "none";
    });

    travelAgent.value = "";
}

function toggleTravelAgentres(bookingSource) {
    // var travelTh = document.getElementById("trvelth");
    var travelTd = document.getElementById("trveltd");
    var travelAgent = document.getElementById("travel_agent");
    console.log(bookingSource);
