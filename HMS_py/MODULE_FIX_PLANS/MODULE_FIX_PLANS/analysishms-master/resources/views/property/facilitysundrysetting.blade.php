...
@section('main-container')
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('faclsundrysetstore') }}" name="facilitysundrysettingform" id="facilitysundrysettingform" method="post">
                                @csrf
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <select name="vtype" id="vtype" class="form-control" required>
                                                <option value="{{ $vtype }}">FACL</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        href="updatefacilitysundrysetting?sn={{ base64_encode($row->sn) }}&vtype={{ base64_encode($row->vtype) }}">
                                                        <button class="btn
    ...
    <script>
        $(document).ready(function() {
            // handleFormSubmission('#facilitysundrysettingform', '#submitBtn', 'faclsundrysetstore');
            let adjustedIndex = 1;
            ...
            $('#facilitysundrysettingform').on('submit', function(e) {
                e.preventDefault();
