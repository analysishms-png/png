            ...
            function initDataTable() {
                ...
                table = $('#fomtax').DataTable({
                    ...
                    ajax: {
                        ...
                        dataSrc: function (json) {
                            ...
                            rows.forEach(r => {
                                ...
                                totalbase2 += num(r.BASEVALUE2);
                                totalcgst9 += num(r.TAXAMT2);
                                totalsgst9 += num(r.TAXAMT4);
                    ...
                    columns: [
                        ...
                        { data: 'BASEVALUE2', render: $.fn.dataTable.render.number(',', '.', 2, '') }, // Goods 9%
                        ...
                        { data: 'TAXAMT2', render: $.fn.dataTable.render.number(',', '.', 2, '') },   // CGST 9%
                        { data: 'TAXAMT4', render: $.fn.dataTable.render.number(',', '.', 2, '') },   // SGST 9%
