...
<div>
    <div class="container-fluid">
        ...
        <div class="logoimg">
            <img alt="{{ companydata()->comp_name }}" class="" id="complogo" src="{{ asset('storage/admin/property_logo/' . companydata()->logo) }}">
        </div>
        <h5 id="compname" class="text-center">{{ companydata()->comp_name }}</h5>
        <div id="end">
            <p class="text-center">Address: <span id="address">{{ companydata()->address1 }}</span></p>
            <p>E-mail: <span id="email">{{ companydata()->email }}</span></p>
            <p>Mobile: <span id="phone">{{ companydata()->mobile }}</span></p>
        </div>
        ...
        <ul class="blangrcul">
            ...
            <li><b>Arbitration:</b> In the event of any dispute arising out of or in connection with the subject matter
                ...
                Rules. Seats of such arbitration shall be in <span class="{{ companydata()->city }}"></span> and proceedings shall be conducted in English. The
                decision of the arbitrator shall be final and binding.</li>
            <li><b>Jurisdiction:</b> Exclusive jurisdiction of the Courts in <span class="compcity">{{ companydata()->city }}</span>.</li>
