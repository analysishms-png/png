                                        ...
                                        <form class="form" name="generalparam" id="generalparam"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label for="blockwisedisp" class="col-form-label">Block Wise Display</label>
                                                    <select id="blockwisedisp" name="blockwisedisp" class="form-control">
                                                        <option value="1" {{ ($fomparamdata->blockwisedisp ?? 0) == 1 ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ ($fomparamdata->blockwisedisp ?? 0) == 0 ? 'selected' : '' }}>No</option>
                                                    </select>
                                                    @error('blockwisedisp')
                                                        <span class="text-danger"> {{ $message }} </span>
                                                    @enderror
                                    ...
                                    <div class="tabby-content">
                                        <form class="form" name="housekeeping" id="housekeeping"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="col-form-label" for="deptnotificationyn">
                                                        Department Wise Notification</label>
                                                    <select id="deptnotificationyn" name="deptnotificationyn" class="form-control">
                                                        @php $deptnotif = old('deptnotificationyn', $fomparamdata->deptnotificationyn ?? 1); @endphp
                                                        <option value="1" {{ $deptnotif == 1 ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ $deptnotif == 0 ? 'selected' : '' }}>No</option>
                                                    </select>
                                                    @error('deptnotificationyn')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
