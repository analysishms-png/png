                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="e.g. DRY CLEAN SHIRT" required
                        ...
                        <div class="table-responsive">
                            <table id="laundryTable" class="table table-hover table-download-with-search table-striped">
                                ...
                                <tbody>
                                    @foreach ($data as $i => $row)
                                        <tr id="row-{{ $row->sn }}">
                                            ...
                                            <td>
                                                @php
                                                    $deptName = isset($row->dcode)
                                                        ? $departments->firstWhere('dcode', $row->dcode)
                                                        : null;
                                                @endphp
                                            ...
                                            <td class="ins">
                                                <button class="btn btn-success btn-sm editBtn" data-sn="{{ $row->sn }}"
                                                    data-name="{{ $row->name }}" data-dcode="{{ $row->dcode ?? '' }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Laundry Service</h5>
