            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="e.g. CLEAN ROOM NOW" required
                    ...
                    <div class="table-responsive">
                        <table id="serviceTable" class="table table-hover table-download-with-search table-striped">
...
$(document).ready(function () {
    new DataTable('#serviceTable', { ordering: true, order: [], pageLength: 25 });

    $('#serviceform').on('submit', function (e) {
        e.preventDefault();
        $('#submitBtn').prop('disabled', true);
        $.ajax({
            url: '{{ route("submitservicemaster") }}',
            type: 'POST',
            data: $(this).serialize(),
