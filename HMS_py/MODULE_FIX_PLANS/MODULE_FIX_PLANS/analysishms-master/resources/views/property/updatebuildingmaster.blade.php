        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="buildingmasterformupdate" id="buildingmasterformupdate"
                                action="{{ route('buildingmasterstoreupdate') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check custom-radio">
                                            <input class="form-check-input" type="radio" value="1" name="activeyn"
                                                id="activeyes" {{ $data->activeyn == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mt-2 custom-radio">
                                            <input class="form-check-input" type="radio" value="0" name="activeyn"
                                                id="activeno" {{ $data->activeyn == 0 ? 'checked' : '' }}>
