                        ...
                        <div class="card-body">
                            <form class="form" action="{{ url('purchaseorderupdate') }}" name="mrentryform" id="mrentryform" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dispmode" class="col-form-label">Dispatch Mode</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="fwdcharge" class="col-form-label">Fright Charges</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="packcharge" class="col-form-label">Packing Charge</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="surc" class="col-form-label">SurCharge</label>
                                            <input type="text" class="form-control" value="{{ $data->surcharge }}" name="surc" id="surc" placeholder="Sur.Charge">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="despthru" class="col-form-label">Dispatch Through</label>
                                            <input type="text" value="{{ $data->despatchthru }}" class="form-control" name="despthru" id="despthru" placeholder="Dispatch Through">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="payterms" class="col-form-label">Payment Terms</label>
                                            <input type="text" value="{{ $data->paymentterms }}" class="form-control" name="payterms" id="payterms" placeholder="Payment Terms">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="remark" class="col-form-label">Expected Delivery</label>
