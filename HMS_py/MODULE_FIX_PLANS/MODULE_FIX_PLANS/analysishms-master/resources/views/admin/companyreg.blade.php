                            ...
                            <div class="form-validation">
                                <form class="form" name="companyregform" id="companyregform"
                                    ...
                                    <div class="text-sm-right">
                                        <a id="bankdetailbtn" class="btn btn-outline-info">Add Bank Details <i
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="acno" id="acno" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" name="maplink" id="maplink" class="form-control"
