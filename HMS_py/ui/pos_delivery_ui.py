...
class PosDeliveryDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        btn_new = QPushButton("New Assignment"); btn_new.clicked.connect(self._new_assignment)
        btn_delivered = QPushButton("Mark Delivered"); btn_delivered.clicked.connect(self._mark_delivered)
