...
class StockReceiveWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.btn_add.setToolTip("Add a new receive line")
        self.btn_del = QPushButton("Remove (-)")
        self.btn_del.setToolTip("Remove the selected receive line")
        self.btn_save = QPushButton("Save Receive")
        self.btn_save.setProperty("success", True)
        self.btn_save.setToolTip("Save the stock receive entry")
        self.btn_exit = QPushButton("Exit")
        self.btn_exit.setToolTip("Close the stock receive form")
