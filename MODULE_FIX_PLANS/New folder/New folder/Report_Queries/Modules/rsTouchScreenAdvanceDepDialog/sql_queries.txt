# ==========================================================
# Module: rsTouchScreenAdvanceDepDialog
...
-- --------------------------------------------
Select SubCode as Code,Name From SubGroup
    where ActiveYN=1 and (LOGSITE_CODE='<LogSiteCode>' or LOGSITE_CODE='HO') AND CompanyType in ('Regular Member', 'Silver Card Member', 'Golden Card Member', 'Corporate Member')
    Order By Name;
