...
-- --------------------------------------------
UPDATE GuestFolio
    SET GuestFolio.mFolioNoDocId='',GuestFolio.mFolioNo = 0
    WHERE GuestFolio.MFolioNoDocid = '<MFolioNoDocid>' And Guestfolio.Docid='<Docid>' And GuestFolio.Docid <>'<Param>';

-- --------------------------------------------
-- Query 3
-- Uses table: GuestFolio
-- --------------------------------------------
SELECT DocId From GuestFolio
...
-- Uses table: RoomOcc
-- --------------------------------------------
Select Top 1 RoomNo,DocId From RoomOcc
    Where FolioNo=<FolioNo> And VPrefix=<VPrefix>
    Order By Sno desc;
...
Select count(*) From RoomOcc
    Where DocId='<DocId>' And (Roomocc.Type Not in ('C','O') OR Roomocc.Type is Null);
...
-- --------------------------------------------
UPDATE PayCharge
    SET RelatedFolioNo=0,RelatedFolioNoDocId=''
