...
## Verified Screens (Housekeeping, Property 103)

| Section | Route |
|---|---|
| Floor Master | floormaster |
| Housekeeper Master | housemaster |
| Cleaning Type | cleaningtype |
| HK Supervisor | hksupervisor |
| Checklist | checklist |
| Amenities Master | amenitiesmaster |
| HK Screen (Shift+H) | housekeepingscreen |
| Room Status Board | roomstatusboard |
| Assignments | assignments |
| Start Cleaning | startcleaning |
| Room Cleaning Entry | roomcleaningentry |
| Inspection | Inspection (capital I) |
| Lost & Found | lostfound |
| Damage Entry | storedamagereport |
| HK Report | housekeepingreport |
| Cleaning Register | cleaningregister |
| Assignment Report | assignmentreport |
| Room-wise Amenities | roomwiseamenitiesreport |
| Damage Report | damagereport |
| Lost&Found Register | lostfoundregister |
| Laundry Memo | salebillentry?dcode=LAUN103 |
| Memo Bill Reprint | posbillentry?dcode=LAUN103 |
| Settlement Entry | settlemententry?dcode=LAUN103 |
| Split Bill | splitbill?dcode=LAUN103 (restricted on demo) |
| Linen Send | laundrysend |
| Linen Receive | laundryreceive |
