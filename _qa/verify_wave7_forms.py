"""Offscreen smoke: Wave-7 walkin_rack_ui 4 openers + registry wired check."""
import os
import sys
...
from HMS_py.ui import walkin_rack_ui as wr  # noqa: E402

OPENERS = [
    ("open_room_view", "RoomViewWindow"),
    ("open_display_rack", "DisplayRackWindow"),
    ("open_roomocc_lookup", "RoomOccLookupWindow"),
    ("open_walkin_entry", "WalkInEntryWindow"),
]
CAPTIONS = ["Room View", "Display Rack",
            "Reservation Look Up Room Wise", "Walk In / Check In Entry"]
